...
function showMessage(response) {
    if (response === "No") {
        ...
        if(noClickCount <= 5){
            ...
            questionElement.textContent =  "Oh,que pena!!Parece que a senhora não queria embarcar na montanha-russa dos meus sentimentos :( "
    ...
    if (response === "Yes") {
        ...
        yesMessage.textContent = "gosto muito de ti bro tamo junto";
